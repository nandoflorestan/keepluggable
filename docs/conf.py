...
# -*- coding: utf-8 -*-
#
# Keepluggable documentation build configuration file, created by
...
copyright = '2013-2021 by Nando Florestan'
...
#html_title = 'Keepluggable v0.4.0'
...
htmlhelp_basename = 'Keepluggabledoc'
...
latex_documents = [
    (master_doc, 'Keepluggable.tex', 'Keepluggable Documentation',
     'Nando Florestan', 'manual'),
]
...
man_pages = [
    (master_doc, 'keepluggable', 'Keepluggable Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Keepluggable', 'Keepluggable Documentation',
     author, 'Keepluggable', 'One line description of project.',
     'Miscellaneous'),
]
